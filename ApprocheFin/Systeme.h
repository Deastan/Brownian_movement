/**
 * \file Systeme.h
 * \brief est le prototype de la classe contenant l'enceinte et les particules 
 ...
 *================================================================================*/
	...
	Enceinte enceinte;
	double temperature; /// const si l'on considère que le systeme est a une pression et un volume constant
